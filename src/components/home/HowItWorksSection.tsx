        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 relative z-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full aspect-[4/3] rounded-2xl border-2 border-[#0C2B4E] bg-white p-3.5 sm:p-4 shadow-sm flex flex-col justify-between mb-6 text-left">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-[#0C2B4E]">{t("howItWorks.step1Title")}</p>
                  <p className="text-[9px] text-slate-400 mb-2">{t("compassCard.step1")}</p>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2 rounded-md border border-slate-100 p-1.5 text-[10px] text-slate-500">
                      ...
                      <span>{t("compassCard.step2")}</span>
                    </div>
                    <div className="flex items-center gap-2 rounded-md border border-slate-100 p-1.5 text-[10px] text-slate-500">
                      <div className="h-2.5 w-2.5 rounded-full border border-slate-300" />
                      <span>{t("compassCard.step3")}</span>
                    </div>
                  </div>
                </div>
              ...
              {/* Title & Description */}
              <h3 className="text-lg font-bold text-[#0C2B4E] mb-2">{t("howItWorks.step1Title")}</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full aspect-[4/3] rounded-2xl border-2 border-[#0C2B4E] bg-white p-3 sm:p-3.5 shadow-sm flex flex-col justify-between mb-6 text-left overflow-hidden">
                <div className="space-y-1.5">
                  <div className="border-b border-slate-100 pb-1">
                    <p className="text-[11px] font-bold text-[#0C2B4E]">{t("guidance.title")}</p>
                  ...
                  <div className="rounded-md border border-slate-100 bg-slate-50/80 p-1.5 space-y-1">
                    <p className="text-[8px] font-bold text-slate-700">{t("guidance.situationSummaryTitle")}</p>
                  ...
                  {/* 3 Step Mini Columns */}
                  <div>
                    <p className="text-[7px] font-bold text-slate-700 mb-0.5">{t("guidance.actionStepsTitle")}</p>
                    <div className="grid grid-cols-3 gap-1 text-[6px]">
                      <div className="rounded border border-slate-100 bg-white p-1">
                        <p className="font-bold text-slate-800">Spitex / CMS</p>
                        <p className="text-slate-400">Home nursing support.</p>
                      </div>
                      <div className="rounded border border-slate-100 bg-white p-1">
                        <p className="font-bold text-slate-800">SVA / AHV (EL)</p>
                        <p className="text-slate-400">Supplementary benefits.</p>
                      </div>
                      <div className="rounded border border-slate-100 bg-white p-1">
                        <p className="font-bold text-slate-800">Respite Care</p>
                        <p className="text-slate-400">Caregiver relief options.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Title & Description */}
              <h3 className="text-lg font-bold text-[#0C2B4E] mb-2">{t("howItWorks.step2Title")}</h3>
              <p className="text-xs sm:text-[13px] text-[#718096] leading-relaxed max-w-xs">
                {t("howItWorks.step2Desc")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              {/* Title & Description */}
              <h3 className="text-lg font-bold text-[#0C2B4E] mb-2">{t("howItWorks.step4Title")}</h3>
              <p className="text-xs sm:text-[13px] text-[#718096] leading-relaxed max-w-xs">
